      ...
      case "Reportes":
        return (
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-sm text-white/60">
              Esta sección está lista para configurarse con la información y
              controles específicos del portal.
            </p>
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (action === "Crear cliente") {
                          setActiveSection("Alta de clientes");
                          return;
                        }
                        if (action === "Actualizar precios") {
                          setActiveSection("Productos");
                          return;
                        }
                        if (action === "Asignar roles") {
                          setActiveSection("Usuarios y roles");
                          return;
                        }
                        if (action === "Revisar pedidos") {
