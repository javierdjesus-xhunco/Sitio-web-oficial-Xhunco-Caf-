...
export default function SuperAdminCheckoutOrdersPage() {
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">
            Supervisa todos los pedidos capturados desde el checkout, actualiza
            su estatus y agrega información de envío para notificar al cliente.
          </p>
        </div>
