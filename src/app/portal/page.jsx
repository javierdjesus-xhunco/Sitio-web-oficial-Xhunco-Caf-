...
const recommendedSections = [
  {
    ...
    description:
      "Permisos granulares por negocio, auditoría de accesos y control de sesiones.",
  },
  {
    title: "Facturación y pagos",
    description:
      "Gestión de facturas, métodos de pago, cuentas por cobrar y cierres contables.",
  },
  {
    title: "Reportes y analítica",
    description:
      "Ventas por cliente, productos top, alertas de baja rotación y KPIs clave.",
  },
  {
    title: "Inventario y logística",
    description:
      "Alertas de stock, fechas de tostado, rutas de entrega y tiempos de preparación.",
  },
  {
...
const products = [
  {
    name: "Café Veracruz 1 kg",
    sku: "CAF-VER-1KG",
    price: "$380",
    status: "Activo",
  },
  {
    name: "Café Chiapas 500 g",
    sku: "CAF-CHI-500",
    price: "$220",
    status: "Activo",
  },
  {
    name: "Café Puebla 250 g",
    sku: "CAF-PUE-250",
    price: "$140",
    status: "Actualización",
  },
  {
    name: "Café Oaxaca 1 kg",
    sku: "CAF-OAX-1KG",
    price: "$410",
    status: "Sin stock",
  },
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-8 md:flex-row md:gap-6 md:px-6 lg:px-8">
        <aside className="flex h-fit flex-col gap-6 rounded-3xl border border-white/10 bg-white/5 p-6 md:sticky md:top-8 md:w-64">
          ...
          <nav className="space-y-2 text-sm">
            {[
              ...
              <button
                key={item}
                className="flex w-full items-center justify-between rounded-xl border border-transparent px-4 py-3 text-left text-white/80 transition hover:border-white/20 hover:bg-white/5"
                type="button"
              >
                <span>{item}</span>
        ...
        <main className="flex-1 space-y-8">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-white/60">
                  Administra clientes, productos y pedidos en un solo lugar. Todo
                  el equipo puede operar desde móvil o escritorio con accesibilidad
                  garantizada.
                </p>
              </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-white/60">
                  Captura la información esencial del negocio y asigna el rol
                  adecuado.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
                ...
                <p className="mt-2 text-sm text-white/60">
                  Visualiza el catálogo y ajusta precios o descripciones de
                  inmediato.
                </p>
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
                ...
                <p className="mt-2 text-sm text-white/60">
                  Ajustes esenciales para operar el portal sin fricción.
                </p>
                <div className="mt-4 space-y-3 text-sm">
                  <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-slate-900/60 p-4">
                    <div>
                      <p className="font-semibold">Precios base</p>
                      <p className="text-xs text-white/50">
                        Actualizar costos y márgenes globales.
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-slate-900/60 p-4">
                    <div>
                      ...
                      <p className="text-xs text-white/50">
                        Correos, WhatsApp y alertas internas.
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-slate-900/60 p-4">
                    <div>
                      ...
                      <p className="text-xs text-white/50">
                        Registros de cambios y accesos críticos.
                      </p>
                    </div>
                    <button
                      type="button"
          ...
          <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-white/60">
                  Historial reciente de entregas completas.
                </p>
              </div>
              <div className="mt-4 space-y-3">
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
            <div className="flex flex-col gap-2">
              <h3 className="text-xl font-semibold">Secciones recomendadas</h3>
              <p className="text-sm text-white/60">
                Complementos clave para fortalecer la operación del portal.
              </p>
            </div>
