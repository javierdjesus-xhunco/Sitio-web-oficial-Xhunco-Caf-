        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mt-6 rounded-2xl border border-white/10 bg-black/20 p-5">
              ...
              <div className="mt-2 flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3">
...
function KPI({ title, value, note }) {
  return (
    <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-5">
      ...
      <div className="mt-2 text-lg md:text-2xl font-semibold break-words">{value}</div>
